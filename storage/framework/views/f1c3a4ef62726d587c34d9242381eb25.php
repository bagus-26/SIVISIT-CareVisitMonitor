<?php $__env->startSection('title', 'Profil Petugas'); ?>
    ...
    <div class="col-12 col-lg-4 sv-animate-in sv-animate-in-1">
        <div class="sv-profile-hero">
            <div class="d-flex align-items-start gap-3 mb-4">
                <div class="sv-profile-avatar"><?php echo e(strtoupper(substr($user->name ?? 'P', 0, 1))); ?></div>
                <div class="sv-profile-info">
                    <div class="profile-name" style="color:white; font-size: 18px; font-weight:700;"><?php echo e($user->name); ?></div>
                    <div class="badge-role">
                        <i class="bi bi-heart-pulse-fill me-1"></i><?php echo e($user->role ?? 'Petugas Kesehatan'); ?>

                    </div>
                    <div class="profile-id" style="color:rgba(255,255,255,0.5); font-size:11px; margin-top:4px;">ID: PM-<?php echo e(date('Y')); ?>-<?php echo e(str_pad($user->id, 4, '0', STR_PAD_LEFT)); ?></div>
                </div>
            </div>

            <div class="profile-stat-row">
                <div class="profile-stat-item">
                    <div class="psi-val"><?php echo e($totalPatients); ?></div>
                    <div class="psi-lbl">Pasien Binaan</div>
                </div>
                <div class="profile-stat-item">
                    <div class="psi-val"><?php echo e($totalMonitoring); ?></div>
        ...
        <div class="sv-card">
            ...
            <div class="d-flex flex-column gap-2">
                ...
                <a href="<?php echo e(route('admin.rekam-medis.index')); ?>" class="btn btn-sm btn-outline-secondary">
                    <i class="bi bi-folder2-open me-1"></i> Lihat Rekam Medis
                </a>
                <a href="<?php echo e(route('logout')); ?>" class="btn btn-sm btn-outline-danger mt-2">
            ...
            <div class="info-card-body">
                ...
                <div class="sv-info-row">
                    ...
                    <div class="info-content">
                        ...
                        <div class="info-value" style="font-family:monospace;font-size:15px;"><?php echo e($user->nip ?? ('19' . date('Y') . '0' . str_pad($user->id, 6, '0', STR_PAD_LEFT))); ?></div>
                    </div>
                </div>
                <div class="sv-info-row">
                    ...
                    <div class="info-content">
                        ...
                        <div class="info-value"><?php echo e($user->role ?? 'Petugas Kesehatan'); ?></div>
                    </div>
                </div>
                <div class="sv-info-row">
                    ...
                    <div class="info-content">
                        ...
                        <div class="info-value"><?php echo e($user->created_at ? $user->created_at->format('d M Y') : date('d M Y')); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="info-card-body">
                ...
                <div class="sv-info-row">
                    ...
                    <div class="info-content">
                        ...
                        <div class="info-value"><?php echo e($user->phone ?? '08' . str_pad($user->id + 22, 9, '2', STR_PAD_LEFT)); ?></div>
                    </div>
                </div>
                <div class="sv-info-row">
                    ...
                    <div class="info-content">
                        ...
                        <div class="info-value"><?php echo e($user->location ?? 'Puskesmas Dinoyo, Malang'); ?></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body" style="padding:24px;">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="role" class="form-control"
                               value="<?php echo e(old('role', $user->role ?? 'Petugas Kesehatan')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sivisit_CareVisitMonitor\resources\views\admin\profil.blade.php ENDPATH**/ ?>
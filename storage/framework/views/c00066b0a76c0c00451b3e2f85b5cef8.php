...
<div class="sv-page-header sv-animate-in">
    <div>
        ...
        <p>
            <span style="color:var(--sv-text-muted);"><?php echo e($monitoring->monitoring_date ? \Carbon\Carbon::parse($monitoring->monitoring_date)->format('d F Y') : '-'); ?></span>
            <?php if($monitoring->monitoring_time): ?>
                <span style="color:var(--sv-border);margin:0 6px;">•</span>
                <span style="color:var(--sv-text-muted);"><?php echo e(\Carbon\Carbon::parse($monitoring->monitoring_time)->format('H:i')); ?> WIB</span>
            <?php endif; ?>
            <span style="color:var(--sv-border);margin:0 6px;">•</span>
            <span style="color:var(--sv-blue);font-weight:600;"><?php echo e($monitoring->user->name ?? 'Petugas'); ?></span>
        </p>
    </div>
    <div class="d-flex gap-2">
        <button onclick="window.print()" class="btn btn-outline-secondary btn-sm">🖨️ Cetak</button>
        <a href="<?php echo e(route('admin.monitorings.create', ['patient_id' => $monitoring->patient_id])); ?>" class="btn btn-primary btn-sm">🩺 Monitoring Baru</a>
        <a href="<?php echo e(route('admin.monitorings.index')); ?>" class="btn btn-outline-secondary btn-sm">← Kembali</a>
    </div>
</div>
    ...
    <div class="col-12 col-xl-8">
        ...
        <div class="sv-card mb-3 sv-animate-in sv-animate-in-1">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <div style="font-size:16px;font-weight:700;margin-top:3px;"><?php echo e($monitoring->patient->patient_name ?? '-'); ?></div>
                </div>
                <div class="col-md-3">
                    ...
                    <div style="font-size:14px;font-weight:600;color:var(--sv-blue);margin-top:3px;"><?php echo e($monitoring->patient_id ?? '-'); ?></div>
                </div>
                <div class="col-md-3">
                    ...
                    <div style="font-size:14px;font-weight:500;margin-top:3px;"><?php echo e($monitoring->monitoring_date ? \Carbon\Carbon::parse($monitoring->monitoring_date)->format('d M Y') : '-'); ?></div>
                </div>
                <div class="col-md-2">
                    <div style="font-size:10.5px;font-weight:600;text-transform:uppercase;letter-spacing:0.8px;color:var(--sv-text-muted);">Jam</div>
                    <div style="font-size:14px;font-weight:500;margin-top:3px;"><?php echo e($monitoring->monitoring_time ? \Carbon\Carbon::parse($monitoring->monitoring_time)->format('H:i').' WIB' : '-'); ?></div>
                </div>
                <?php if($monitoring->patient->address ?? false): ?>
                <div class="col-12">
                    ...
                    <div style="font-size:13.5px;color:var(--sv-text-sub);margin-top:3px;">📍 <?php echo e($monitoring->patient->address); ?></div>
                </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="sv-card mb-3 sv-animate-in sv-animate-in-2">
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;">
                ...
                ?>
                <span class="sv-badge <?php echo e($statusCls); ?>"><?php echo e($statusLbl); ?></span>
            </div>
            <div class="row g-3">
                ...
                <div class="col-6 col-md-4">
                    <div class="sv-vital-card">
                        ...
                        <div class="sv-vital-big">
                            <span class="val"><?php echo e($sys); ?></span>
                            <span class="sep">/</span>
                            <span class="val"><?php echo e($dia); ?></span>
                            <span class="unit">mmHg</span>
                        </div>
                        <div class="vital-status vital-<?php echo e($bpClass); ?>"><?php echo e($bpLabel); ?></div>
                        <?php else: ?>
                        <div class="sv-vital-big"><span class="val" style="font-size:24px;"><?php echo e($monitoring->blood_pressure ?? '-'); ?></span></div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-4">
                    <div class="sv-vital-card">
                        ...
                        <div class="sv-vital-big">
                            <span class="val"><?php echo e($temp ? number_format($temp,1) : '-'); ?></span>
                            <span class="unit">°C</span>
                        </div>
                        <?php if($temp): ?>
                        <div class="vital-status vital-<?php echo e($tempClass); ?>"><?php echo e($tempLabel); ?></div>
                        <?php endif; ?>
                    </div>
                </div>

                
                <?php if($monitoring->heart_rate): ?>
                <div class="col-6 col-md-4">
                    <div class="sv-vital-card">
                        <div class="vital-label"><span>💓</span> Nadi</div>
                        <div class="sv-vital-big">
                            <span class="val"><?php echo e($monitoring->heart_rate); ?></span>
                            <span class="unit">bpm</span>
                        </div>
                        <div class="vital-status vital-<?php echo e(($monitoring->heart_rate>=60&&$monitoring->heart_rate<=100)?'normal':'warning'); ?>">
                            <?php echo e(($monitoring->heart_rate>=60&&$monitoring->heart_rate<=100)?'Normal':'Di luar normal'); ?>
                ...
                <?php if($monitoring->respiratory_rate): ?>
                <div class="col-6 col-md-4">
                    <div class="sv-vital-card">
                        <div class="vital-label"><span>🫁</span> Laju Napas</div>
                        <div class="sv-vital-big">
                            <span class="val"><?php echo e($monitoring->respiratory_rate); ?></span>
                            <span class="unit">x/mnt</span>
                        </div>
                        <div class="vital-status vital-<?php echo e(($monitoring->respiratory_rate>=12&&$monitoring->respiratory_rate<=20)?'normal':'warning'); ?>">
                            <?php echo e(($monitoring->respiratory_rate>=12&&$monitoring->respiratory_rate<=20)?'Normal':'Di luar normal'); ?>
                ...
                <?php if($monitoring->oxygen_saturation): ?>
                <div class="col-6 col-md-4">
                    <div class="sv-vital-card">
                        <div class="vital-label"><span>🩸</span> Saturasi O₂</div>
                        <div class="sv-vital-big">
                            <span class="val"><?php echo e(number_format($monitoring->oxygen_saturation,0)); ?></span>
                            <span class="unit">%</span>
                        </div>
                        <div class="vital-status vital-<?php echo e($monitoring->oxygen_saturation>=95?'normal':'danger'); ?>">
                            <?php echo e($monitoring->oxygen_saturation>=95?'Normal':'⚠️ Rendah'); ?>
        ...
        <div class="sv-card sv-animate-in sv-animate-in-3">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <p style="font-size:13.5px;color:var(--sv-text-sub);line-height:1.7;"><?php echo e($monitoring->symptoms ?? 'Tidak ada catatan.'); ?></p>
                </div>
                <div class="col-md-6">
                    ...
                    <p style="font-size:13.5px;color:var(--sv-text-sub);line-height:1.7;"><?php echo e($monitoring->notes ?? 'Tidak ada catatan.'); ?></p>
                </div>
            </div>
            <div class="row g-3 mt-2">
                <div class="col-md-6">
                    ...
                    <p style="font-size:13.5px;color:var(--sv-text-sub);line-height:1.7;"><?php echo e($monitoring->recommendation ?? 'Tidak ada rekomendasi.'); ?></p>
                </div>
                <div class="col-md-6">
                    ...
                    <p style="font-size:13.5px;color:var(--sv-text-sub);line-height:1.7;">
                        <?php echo e($monitoring->next_visit_date ? \Carbon\Carbon::parse($monitoring->next_visit_date)->format('d M Y') : 'Belum dijadwalkan'); ?>
        ...
        <div class="sv-card sv-animate-in mt-3" id="mapCard">
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:14px;">
                ...
                <div>
                    ...
                    <div style="font-size:11.5px;color:var(--sv-text-muted);"><?php echo e($monitoring->patient->address); ?></div>
                </div>
            </div>
    ...
    <div class="col-12 col-xl-4 sv-animate-in">
        <div class="sv-card h-100">
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;">
                ...
                <a href="<?php echo e(route('admin.rekam-medis.index', ['patient_id' => $monitoring->patient_id])); ?>"
                   style="font-size:12px;color:var(--sv-blue);">Lihat Semua</a>
            </div>
            <div style="display:flex;flex-direction:column;gap:8px;">
                <?php $__empty_1 = true; $__currentLoopData = $patientHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                ?>
                <a href="<?php echo e(route('admin.monitorings.show', $hist->id)); ?>"
                   style="display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:8px;border:1px solid <?php echo e($hist->id === $monitoring->id ? '#007AFF' : 'var(--sv-border)'); ?>;background:<?php echo e($hist->id === $monitoring->id ? '#E8F1FF' : 'white'); ?>;text-decoration:none;transition:all 0.2s;"
                   class="history-link">
                    <div style="width:8px;height:8px;border-radius:50%;background:<?php echo e($dotColors[$hCls]); ?>;flex-shrink:0;"></div>
                    <div style="flex:1;overflow:hidden;">
                        <div style="font-size:12px;font-weight:600;color:var(--sv-text-main);">
                            <?php echo e($hist->monitoring_date ? \Carbon\Carbon::parse($hist->monitoring_date)->format('d M Y') : '-'); ?>

                        </div>
                        <div style="font-size:11px;color:var(--sv-text-muted);">
                            <?php echo e($hist->blood_pressure ?? '-'); ?> mmHg
                            <?php if($hist->body_temperature): ?> · <?php echo e($hist->body_temperature); ?>°C <?php endif; ?>
                        </div>
                    </div>
                    <?php if($hist->id === $monitoring->id): ?>
            ...
            <div class="mt-3 pt-3" style="border-top:1px solid var(--sv-border);">
                <a href="<?php echo e(route('admin.monitorings.create', ['patient_id' => $monitoring->patient_id])); ?>"
...
<script>
(function() {
    var address = <?php echo json_encode($monitoring->patient->address ?? '', 15, 512) ?>;
    if (!address) return;
    ...
    fetch(url, { headers: { 'Accept-Language': 'id' } })
        ...
        .then(function(data) {
            ...
            L.marker([lat, lon], { icon: icon })
                .addTo(map)
                .bindPopup(
                    '<strong style="font-size:13px;"><?php echo e($monitoring->patient->patient_name ?? "Pasien"); ?></strong>' +
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sivisit_CareVisitMonitor\resources\views\monitoring\show.blade.php ENDPATH**/ ?>
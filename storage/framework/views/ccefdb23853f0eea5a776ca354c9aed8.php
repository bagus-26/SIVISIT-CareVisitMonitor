<?php $__env->startSection('title', 'Catat Monitoring'); ?>
...
<div class="sv-page-header sv-animate-in">
    ...
    <a href="<?php echo e(route('admin.monitorings.index')); ?>" class="btn btn-outline-secondary">← Kembali</a>
</div>
...
<form action="<?php echo e(route('admin.monitorings.store')); ?>" method="POST" id="monForm" novalidate>
    <?php echo csrf_field(); ?>
    <div class="row g-3">
                    ...
                    <div class="row g-3">
                        <div class="col-md-5">
                            ...
                            <select name="patient_id" id="patient_id" class="form-select" required>
                                <option value="" disabled <?php echo e(old('patient_id', $prePatientId) ? '' : 'selected'); ?>>— Pilih Pasien —</option>
                                ...
                                <option value="<?php echo e($p->patient_id); ?>"
                                    <?php echo e(old('patient_id', $prePatientId) === $p->patient_id ? 'selected' : ''); ?>>
                                    <?php echo e($p->patient_name); ?> — <?php echo e($p->patient_id); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="monitoring_date" id="monitoring_date" class="form-control"
                                   value="<?php echo e(old('monitoring_date', date('Y-m-d'))); ?>"
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="blood_pressure" id="blood_pressure" class="form-control"
                                   ...
                                   value="<?php echo e(old('blood_pressure')); ?>" required pattern="\d{2,3}\/\d{2,3}">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="body_temperature" id="body_temperature" class="form-control"
                                   placeholder="Contoh: 36.5" value="<?php echo e(old('body_temperature')); ?>"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="heart_rate" id="heart_rate" class="form-control"
                                   placeholder="Contoh: 80" value="<?php echo e(old('heart_rate')); ?>" min="30" max="250">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="respiratory_rate" id="respiratory_rate" class="form-control"
                                   placeholder="Contoh: 18" value="<?php echo e(old('respiratory_rate')); ?>" min="5" max="60">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="oxygen_saturation" id="oxygen_saturation" class="form-control"
                                   placeholder="Contoh: 98" value="<?php echo e(old('oxygen_saturation')); ?>"
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <textarea name="symptoms" id="symptoms" class="form-control" rows="3"
                                      placeholder="Deskripsikan keluhan atau kondisi yang ditemukan..." required><?php echo e(old('symptoms')); ?></textarea>
                        </div>
                        <div class="col-md-6">
                            <label for="notes" class="form-label">Catatan Petugas</label>
                            <textarea name="notes" id="notes" class="form-control" rows="3"
                                      placeholder="Catatan tambahan petugas..."><?php echo e(old('notes')); ?></textarea>
                        </div>
                    </div>
                    <div class="row g-3 mt-2">
                        <div class="col-md-6">
                            ...
                            <textarea name="recommendation" id="recommendation" class="form-control" rows="2"
                                      placeholder="Contoh: Jadwalkan kontrol ulang dalam 3 hari..."><?php echo e(old('recommendation')); ?></textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="next_visit_date" id="next_visit_date" class="form-control"
                                   value="<?php echo e(old('next_visit_date')); ?>" min="<?php echo e(date('Y-m-d')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sivisit_CareVisitMonitor\resources\views\monitoring\create.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'AI Usage Log'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="sv-table-wrap sv-animate-in mb-4">
        <div class="sv-section-header">
            ...
            <div class="d-flex gap-2 align-items-center">
                <span style="font-size:12px;color:#8E8E93;"><?php echo e($aiLogs->count()); ?> entri</span>
        ...
        <div class="table-responsive">
            <table class="table mb-0" id="aiLogTable">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $aiLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td style="color:#8E8E93;font-size:13px;"><?php echo e($i + 1); ?></td>
                            <td>
                                <span class="sv-date-badge">
                                    <?php echo e($log->tanggal->format('d M Y')); ?>

                                </span>
                            </td>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <div class="sv-member-avatar"><?php echo e(strtoupper(substr($log->nama_anggota, 0, 1))); ?></div>
                                    <span style="font-size:13px;font-weight:500;"><?php echo e($log->nama_anggota); ?></span>
                                </div>
                            </td>
                            <td>
                                <span class="sv-tool-badge">
                                    <i class="bi bi-cpu me-1"></i><?php echo e($log->tools_ai); ?>

                                </span>
                            </td>
                            <td>
                                <div class="sv-log-text"><?php echo e($log->prompt_penting); ?></div>
                            </td>
                            <td>
                                <div class="sv-log-text sv-log-result"><?php echo e($log->hasil_dari_ai); ?></div>
                            </td>
                            <td>
                                <div class="sv-log-text sv-log-verify"><?php echo e($log->verifikasi_revisi_tim); ?></div>
                            </td>
                            <td style="text-align:center;">
                                <form action="<?php echo e(route('admin.usage-log.destroy-ai', $log->id)); ?>" method="POST"
    ...
    <div class="sv-table-wrap sv-animate-in">
        <div class="sv-section-header">
            ...
            <span style="font-size:12px;color:#8E8E93;"><?php echo e($systemLogs->count()); ?> aktivitas terakhir</span>
        </div>
        <div class="table-responsive">
            <table class="table mb-0">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $systemLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td style="color:#8E8E93;font-size:13px;"><?php echo e($i + 1); ?></td>
                            <td style="font-size:12px;color:#636366;white-space:nowrap;">
                                <?php echo e($log->created_at->format('d M Y')); ?><br>
                                <span style="color:#8E8E93;"><?php echo e($log->created_at->format('H:i:s')); ?> WIB</span>
                            </td>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        <div style="font-size:13px;font-weight:600;"><?php echo e($log->user_name ?? 'Sistem'); ?></div>
                                        <?php if($log->user): ?>
                                            <div style="font-size:11px;color:#8E8E93;"><?php echo e($log->user->email); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            <td>
                                ...
                                ?>
                                <span class="sv-badge" style="background:<?php echo e($bg); ?>;color:<?php echo e($fg); ?>;font-size:11px;">
                                    <?php echo e($log->action); ?>

                                </span>
                            </td>
                            <td style="font-size:12.5px;font-weight:500;color:#007AFF;"><?php echo e($log->module); ?></td>
                            <td style="font-size:13px;color:#636366;"><?php echo e($log->description ?? '-'); ?></td>
                            <td style="font-size:11.5px;color:#8E8E93;font-family:monospace;"><?php echo e($log->ip_address ?? '-'); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="7">
    ...
    <div class="modal fade" id="addAiLogModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content" style="border-radius:16px;border:none;box-shadow:0 20px 60px rgba(0,0,0,0.15);">
                <form action="<?php echo e(route('admin.usage-log.store-ai')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sivisit_CareVisitMonitor\resources\views\admin\usage-log.blade.php ENDPATH**/ ?>
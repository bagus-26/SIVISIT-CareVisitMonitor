...
<nav class="lp-nav" id="lpNav">
    <div class="container-xl">
        <div class="lp-nav-inner">
            <a href="<?php echo e(url('/')); ?>" class="lp-brand">
            ...
            <a href="<?php echo e(route('login')); ?>" class="lp-btn-login">
        ...
        <div class="row align-items-center" style="min-height:86vh;padding:120px 0 60px;">
            <div class="col-lg-6">
                ...
                <div class="lp-hero-cta">
                    <a href="<?php echo e(route('login')); ?>" class="lp-btn-primary">
                        🚀 Mulai Monitoring
                    </a>
...
<section class="lp-cta-section">
    <div class="container-xl text-center">
        <div class="lp-cta-inner">
            ...
            <a href="<?php echo e(route('login')); ?>" class="lp-btn-cta">
                Masuk ke Dashboard →
            </a>
...
<?php /**PATH C:\laragon\www\sivisit_CareVisitMonitor\resources\views\welcome.blade.php ENDPATH**/ ?>
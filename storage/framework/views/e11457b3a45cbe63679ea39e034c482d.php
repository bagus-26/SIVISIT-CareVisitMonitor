<?php $__env->startSection('title', 'Lokasi Saya'); ?>
...
<div class="row g-3">
    ...
    <div class="col-12 col-lg-4">
        <div class="sv-card sv-animate-in">
            ...
            <div class="sv-card-body">
                <div class="d-flex align-items-center gap-3 mb-3">
                    <span class="status-pulse <?php echo e($user->latitude ? 'active' : 'inactive'); ?>" id="statusDot"></span>
                    <div>
                        <div style="font-weight:600;font-size:14px;" id="statusText">
                            <?php echo e($user->latitude ? 'Lokasi terkirim' : 'Belum berbagi lokasi'); ?>

                        </div>
                        <div class="location-coord" id="lastUpdate">
                            <?php echo e($user->last_location_at ? 'Terakhir: '.$user->last_location_at->diffForHumans() : '-'); ?>
                ...
                <div class="location-coord mb-3" id="coordDisplay">
                    <?php if($user->latitude && $user->longitude): ?>
                        <?php echo e(number_format((float)$user->latitude, 6)); ?>, <?php echo e(number_format((float)$user->longitude, 6)); ?>
        ...
        <div class="sv-card sv-animate-in mt-3">
            ...
            <div class="sv-card-body">
                <div class="d-flex justify-content-around text-center">
                    <div>
                        <div style="font-size:24px;font-weight:800;color:var(--sv-blue);"><?php echo e($assignedPatients->count()); ?></div>
                        <div style="font-size:11px;color:var(--sv-text-muted);">Pasien Binaan</div>
                    </div>
                    <div>
                        <div style="font-size:24px;font-weight:800;color:var(--sv-blue);"><?php echo e($todayVisits); ?></div>
        ...
        <?php if($assignedPatients->isNotEmpty()): ?>
        <div class="sv-card sv-animate-in mt-3">
            <div class="sv-card-header">
                <h5><i class="bi bi-people me-2"></i>Pasien Binaan</h5>
            </div>
            <div class="sv-card-body p-0">
                <?php $__currentLoopData = $assignedPatients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="d-flex align-items-center gap-2 p-3 border-bottom" style="font-size:13px;">
                    <div style="width:32px;height:32px;border-radius:50%;background:var(--sv-blue);display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;color:white;flex-shrink:0;">
                        <?php echo e(strtoupper(substr($p->patient_name ?? 'P', 0, 1))); ?>

                    </div>
                    <div style="flex:1;min-width:0;">
                        <div style="font-weight:600;"><?php echo e($p->patient_name ?? '-'); ?></div>
                        <div style="font-size:10px;color:var(--sv-text-muted);"><?php echo e($p->patient_id); ?> · <?php echo e($p->patient_category ?? '-'); ?></div>
                    </div>
                    <a href="<?php echo e(route('admin.monitorings.create', ['patient_id' => $p->patient_id])); ?>" class="btn btn-sm btn-outline-primary py-0" style="font-size:11px;">
...
let initialLat = <?php echo e($user->latitude ?? 'null'); ?>;
let initialLng = <?php echo e($user->longitude ?? 'null'); ?>;
...
function sendLocation(lat, lng, accuracy) {
    fetch('<?php echo e(route("admin.location.update")); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sivisit_CareVisitMonitor\resources\views\admin\location\petugas.blade.php ENDPATH**/ ?>
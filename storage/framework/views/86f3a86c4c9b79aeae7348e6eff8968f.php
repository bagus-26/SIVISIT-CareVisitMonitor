<?php $__env->startSection('title', 'Registrasi Pasien'); ?>
...
<form action="<?php echo e(route('admin.patients.store')); ?>" method="POST" id="patientForm">
    <?php echo csrf_field(); ?>
    <div class="row g-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="assigned_officer_id" id="assigned_officer_id" class="form-select" required>
                            ...
                            <?php $__currentLoopData = $petugas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($p->id); ?>" <?php echo e(old('assigned_officer_id') == $p->id ? 'selected' : ''); ?>>
            ...
            <div class="form-section h-100 mb-0">
                ...
                <div class="form-section-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="patient_id" id="patient_id" class="form-control" placeholder="Contoh: P005" value="<?php echo e(old('patient_id')); ?>" required>
                    ...
                    <div class="mb-0">
                        ...
                        <input type="datetime-local" name="monitoring_date" id="monitoring_date" class="form-control" value="<?php echo e(old('monitoring_date')); ?>">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="form-section-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nik_dummy" id="nik_dummy" class="form-control" placeholder="Masukkan 16 digit NIK" value="<?php echo e(old('nik_dummy')); ?>" required pattern="\d{16}">
                        </div>

                        <div class="col-md-6">
                            <label for="patient_name" class="form-label">Nama Lengkap Pasien <span style="color:#FF3B30;">*</span></label>
                            <input type="text" name="patient_name" id="patient_name" class="form-control" placeholder="Masukkan nama pasien" value="<?php echo e(old('patient_name')); ?>" required>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="patient_category" id="patient_category" class="form-select" required>
                                ...
                                <option value="Balita" <?php echo e(old('patient_category') == 'Balita' ? 'selected' : ''); ?>>👶 Balita (0 - 5 Tahun)</option>
                                <option value="Anak-anak" <?php echo e(old('patient_category') == 'Anak-anak' ? 'selected' : ''); ?>>👦 Anak-anak</option>
                                <option value="Dewasa" <?php echo e(old('patient_category') == 'Dewasa' ? 'selected' : ''); ?>>🧑 Dewasa</option>
                                <option value="Lansia" <?php echo e(old('patient_category') == 'Lansia' ? 'selected' : ''); ?>>🧓 Lansia (Lanjut Usia)</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" name="datebirth" id="datebirth" class="form-control" value="<?php echo e(old('datebirth')); ?>" required>
                        </div>

                        <div class="col-md-8">
                            <label for="address" class="form-label">Alamat Rumah Lengkap <span style="color:#FF3B30;">*</span></label>
                            <input type="text" name="address" id="address" class="form-control" placeholder="Nama jalan, nomor rumah, RT/RW, desa/kelurahan, kecamatan" value="<?php echo e(old('address')); ?>" required>
                        </div>

                        <div class="col-md-4">
                            <label for="family_phone" class="form-label">Nomor Telepon Keluarga <span style="color:#FF3B30;">*</span></label>
                            <input type="tel" name="family_phone" id="family_phone" class="form-control" placeholder="Contoh: 081234xxxxxx" value="<?php echo e(old('family_phone')); ?>" required>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sivisit_CareVisitMonitor\resources\views\patient\tambah-pasien.blade.php ENDPATH**/ ?>
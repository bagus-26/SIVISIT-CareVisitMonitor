    ...
    <div class="col-12 col-lg-4 sv-animate-in sv-animate-in-1">
        <div class="sv-profile-hero">
            <div class="d-flex align-items-start gap-3 mb-4">
                ...
                <div class="sv-profile-info">
                    ...
                    <div class="badge-role">🏥 {{ $user->role ?? 'Petugas Kesehatan' }}</div>
        ...
        <div class="sv-card">
            ...
            <div class="d-flex flex-column gap-2">
                ...
                <a href="{{ route('admin.rekam-medis.index') }}" class="btn btn-sm btn-outline-secondary">📂 Lihat Rekam Medis</a>
                <a href="{{ route('logout') }}" class="btn btn-sm btn-outline-danger mt-2">🚪 Keluar</a>
            </div>
        </div>
    </div>
            ...
            <form action="{{ route('admin.profil.update') }}" method="POST">
                ...
                <div class="modal-body" style="padding:24px;">
                    ...
                    <div class="p-3 rounded" style="background:#F8F9FA;font-size:12px;color:#636366;">
                        ℹ️ Perubahan akan disimpan ke database secara permanen.
                    </div>
                </div>
